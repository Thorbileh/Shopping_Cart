...
const HotelInfomation = () => {
    ...
    const viewMore = () => {
        ...
        navigate("/KhayaLamiRooms")
    }
    return (
        <body>
            <div className={hotelMod.hotelBackg}>
                <img src={hotel3} alt='' width='1700' />
            ...
            <div>
                <div className={hotelMod.whiteSide}>
                    <div className={hotelMod.downText}>
                        <h1 className={hotelMod.h1}>Welcome to khayalami Hotel</h1>
                    ...
                    <div className={hotelMod.gallary}>
                        <div className={hotelMod.pic1}><img src={pic31} /></div>
                        <div className={hotelMod.pic2} ><img src={pic32}></img></div>
